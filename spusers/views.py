...
from spusers.serializers import (
    UserSerializer,
...
class RegisterView(APIView):
    ...
    def post(self, request):
        ...
        user.save()
        dataobj = {"data": serializer.data, "success": True}

        return HttpResponse(
            json.dumps(dataobj, cls=DjangoJSONEncoder),
            content_type="application/json",
...
class UserLoginAPIView(APIView):
    ...
    def post(self, request):
        ...
        return HttpResponse(
            json.dumps(data_obj, cls=DjangoJSONEncoder),
            content_type="application/json",
            status=HTTP_200_OK,
        )
...
class UserProfileAPIView(generics.RetrieveAPIView):
    ...
    def get(self, request):
        ...
        try:
            image = (
                Image.objects.filter(user=user)
                .filter(is_profile=True)
                .order_by("created")
                .reverse()[0]
            )
        ...
        user_obj = {
            ...
            "profile_image": image_obj,
        }

        data_obj = {"data": user_obj, "success": True}
        return HttpResponse(
            json.dumps(data_obj, cls=DjangoJSONEncoder),
            content_type="application/json",
            status=HTTP_200_OK,
...
class UserProfileImageUpdateAPIView(APIView):
    ...
    def post(self, request):
        ...
        dataobj = {"data": data_to_send, "success": True}
...
class UserListAPIView(APIView):
    ...
    def get(self, request):
        ...
        data_obj = {"data": users, "success": True}
        return HttpResponse(
            json.dumps(data_obj, cls=DjangoJSONEncoder),
            content_type="application/json",
            status=HTTP_200_OK,
